...
DMA_ATTR uint16_t* dma_buff[50];
///DMA_ATTR uint16_t dma_buff[50][1000];
DMA_ATTR lldesc_t dma_descriptor[50];

///DMA_ATTR uint16_t* dma_buff2[2];
...
///_dma_desc[i].buf = (uint8_t*)&dma_buff2[i][0];
...
/*
  // Create RX DMA buffers 
    ...
    dma_descriptor[1].eof = 1;
    //pointer to the next descriptor
    dma_descriptor[1].qe.stqe_next = &dma_descriptor[2];

    //buff 2
    dma_descriptor[2].length = 0; //number of byte written to the buffer
    dma_descriptor[2].size = sizeof(dma_buff[2]); //max size of the buffer in bytes
    dma_descriptor[2].owner = 1;
    dma_descriptor[2].sosf = 1;
    dma_descriptor[2].buf = (uint8_t*)&dma_buff[2][0];
    dma_descriptor[2].offset = 0;
    dma_descriptor[2].empty = 0;
    dma_descriptor[2].eof = 1;
    //pointer to the next descriptor
    dma_descriptor[2].qe.stqe_next = &dma_descriptor[3];

    //buff 3
    dma_descriptor[3].length = 0; //number of byte written to the buffer
    dma_descriptor[3].size = sizeof(dma_buff[3]); //max size of the buffer in bytes
    dma_descriptor[3].owner = 1;
    dma_descriptor[3].sosf = 1;
    dma_descriptor[3].buf = (uint8_t*)&dma_buff[3][0];
    dma_descriptor[3].offset = 0;
    dma_descriptor[3].empty = 0;
    dma_descriptor[3].eof = 1;
    //pointer to the next descriptor
    dma_descriptor[3].qe.stqe_next = &dma_descriptor[0];
*/
/*
