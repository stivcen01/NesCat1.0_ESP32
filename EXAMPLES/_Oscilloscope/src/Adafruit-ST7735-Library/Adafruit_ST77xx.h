...
#include "../../src/Adafruit-GFX-Library/Adafruit_SPITFT.h"    // Core graphics library
#include "../../src/Adafruit-GFX-Library/Adafruit_SPITFT_Macros.h"    // Core graphics library
