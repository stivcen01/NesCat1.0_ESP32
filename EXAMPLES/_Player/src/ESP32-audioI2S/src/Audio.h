...
//-------------------------------------------------------------------------------
#ifndef SOFTSD_MOSI_PIN
#define SOFTSD_MOSI_PIN (GPIO_NUM_33)
#endif
#ifndef SOFTSD_MISO_PIN
#define SOFTSD_MISO_PIN (GPIO_NUM_22)
#endif
#ifndef SOFTSD_SCK_PIN
#define SOFTSD_SCK_PIN (GPIO_NUM_21)
#endif

///extern SdFatSoftSpi<SOFTSD_MISO_PIN, SOFTSD_MOSI_PIN, SOFTSD_SCK_PIN> SD;
extern SdFat SD;
...
///    bool connecttoFS(fs::FS &fs, String file);
    bool connecttoFS(SdFat &fs, String file);
...
public:
    ...
    int8_t          m_DIN=-1;                        // Data In, can be negative if unused (I2S_PIN_NO_CHANGE is -1)
